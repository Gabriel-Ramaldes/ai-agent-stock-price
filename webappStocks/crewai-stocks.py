...
yahoo_finance_tool = Tool(
    ...
    description = "Fetches Stocks prices for {ticket} from the last year about a specif stock from Yahoo Finance API",
...
#Criando o Agente de stock price analyst 
...
#Criando a task get Stock price history
getStockPrice= Task(
...
#Criando o Agent de analise de noticas de stock
newsAnalyst = Agent(
    ...
    backstory="""You're highly experienced in analyzing the stock market trends and news and have tracked assets for more then 10 years.
...
#Criando a task get news sobre uma ação
get_news = Task(
...
#Criando o agente de analise do mercado de ações.
